...
const Layout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="min-h-screen  flex">
      ...
      <aside className="hidden md:flex md:flex-col md:w-64 bg-white border-r border-gray-200 fixed h-screen">
        ...
        <div className="h-16 flex items-center justify-center border-b border-gray-200 bg-linear-to-r from-orange-500 to-orange-600">
          <div className="flex items-center space-x-2">
            ...
            <Link to={'/dashboard'} className="text-xl font-bold text-white">News Panel</Link>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-all duration-200"
          >
      ...
      >
        {/* Logo Section */}
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 bg-gradient-to-r from-orange-500 to-orange-600">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="md:hidden h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg font-bold text-gray-800">News Panel</span>
          </div>
          <div className="w-6"></div> {/* Spacer for alignment */}
        </header>

        {/* Page Content */}
        <main className="flex-1 overflow-y-auto xl:p-12 lg:p-12 md:p-12 sm:p-4">
          {children}
        </main>
      </div>
    </div>
